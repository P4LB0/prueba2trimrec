...
public class Vuelo 
{
    ...
    public String toString() {
        return "Vuelo{" + "numVuelo=" + numVuelo + ", origen=" + origen + ", destino=" + destino + ", capacidad=" + capacidad + ", numAsientosQueFaltan=" + numAsientosQueFaltan + ", precioOriginal=" + precioOriginal + '}';
    }
